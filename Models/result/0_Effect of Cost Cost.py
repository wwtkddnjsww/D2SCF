...
plt.xticks([4,8,12,16,20],fontsize=14)
...
print([-np.array(ddpg_graph)+np.array(ddpg_max),np.array(ddpg_graph)-np.array(ddpg_min)])
plt.xlabel('$N_T$')
plt.ylabel('Total Cost')
#
# #plt.title('Client model bit')
plt.legend(loc='best',edgecolor='black',fontsize=14,fancybox=False)#bbox_to_anchor=(0.9,0.0)
plt.savefig('../r_errorbar.eps',dpi=200,transparent=True,bbox_inches='tight')
plt.show()
# target_acc=70
