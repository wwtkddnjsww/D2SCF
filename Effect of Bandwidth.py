...
experiment_list = [1,2,3,4,5,10,15,20,25,30]
cost_weight = 0.5
for ex_i in range(len(experiment_list)):
    ...
    state = SC_MTL_State()
    state.set_parameter(experiment_list[ex_i], layers_size, output_size)
    ...
    np.save('Bandwidth/result/DDPG_Cost'+str(cost_weight)+"_"+str(ex_i)+'.npy',returns)
    np.save('Bandwidth/result/Edge_Cost'+str(cost_weight)+"_"+str(ex_i)+'.npy',edge_returns)
    np.save('Bandwidth/result/MD_Cost'+str(cost_weight)+"_"+str(ex_i)+'.npy',md_returns)
    np.save('Bandwidth/result/Head_Cost'+str(cost_weight)+"_"+str(ex_i)+'.npy',head_returns)
    np.save('Bandwidth/result/RAND_Cost'+str(cost_weight)+"_"+str(ex_i)+'.npy',random_returns)

    np.save('Bandwidth/result/DDPG_EC'+str(cost_weight)+"_"+str(ex_i)+'.npy',ddpg_avg_ec)
    np.save('Bandwidth/result/DDPG_TC'+str(cost_weight)+"_"+str(ex_i)+'.npy',ddpg_avg_tc)
    np.save('Bandwidth/result/EDGE_EC'+str(cost_weight)+"_"+str(ex_i)+'.npy',edge_avg_ec)
    np.save('Bandwidth/result/EDGE_TC'+str(cost_weight)+"_"+str(ex_i)+'.npy',edge_avg_tc)
    np.save('Bandwidth/result/Head_EC'+str(cost_weight)+"_"+str(ex_i)+'.npy',head_avg_ec)
    np.save('Bandwidth/result/Head_TC'+str(cost_weight)+"_"+str(ex_i)+'.npy',head_avg_tc)
    np.save('Bandwidth/result/MD_EC'+str(cost_weight)+"_"+str(ex_i)+'.npy',  md_avg_ec)
    np.save('Bandwidth/result/MD_TC'+str(cost_weight)+"_"+str(ex_i)+'.npy',  md_avg_tc)
    np.save('Bandwidth/result/RAND_EC'+str(cost_weight)+"_"+str(ex_i)+'.npy',rand_avg_ec)
    np.save('Bandwidth/result/RAND_TC'+str(cost_weight)+"_"+str(ex_i)+'.npy',rand_avg_tc)
