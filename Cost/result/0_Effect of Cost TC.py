...
for i in range(0,10):
    ...
    ddpg_min.append(np.min(np.load('DDPG_TC' + str(i) + '.npy')))
    ddpg_max.append(np.max(np.load('DDPG_TC' + str(i) + '.npy')))

    static_graph.append(np.mean(np.load('Head_TC'+str(i)+'.npy')))
    static_min.append(np.min(np.load('Head_TC'+str(i)+'.npy')))
    static_max.append(np.max(np.load('Head_TC' + str(i) + '.npy')))

    md_graph.append(np.mean(np.load('MD_TC'+str(i)+'.npy')))
    md_min.append(np.min(np.load('MD_TC'+str(i)+'.npy')))
    md_max.append(np.max(np.load('MD_TC'+str(i)+'.npy')))

    edge_graph.append(np.mean(np.load('Edge_TC'+str(i)+'.npy')))
    edge_min.append(np.min(np.load('Edge_TC' + str(i) + '.npy')))
    edge_max.append(np.max(np.load('Edge_TC' + str(i) + '.npy')))

    rand_graph.append(np.mean(np.load('RAND_TC'+str(i)+'.npy')))
    rand_min.append(np.min(np.load('RAND_TC' + str(i) + '.npy')))
    rand_max.append(np.max(np.load('RAND_TC' + str(i) + '.npy')))
...
plt.legend(edgecolor='black',fontsize=14,fancybox=False, bbox_to_anchor=(0.3,0.73))
