...
for i in range(10):
    ddpg = np.load('DDPG_Cost0.5_' + str(i) + '.npy')
    ddpg_graph.append(np.mean(ddpg))
    ddpg_min.append(np.min(np.load('DDPG_Cost0.5_' + str(i) + '.npy')))
    ddpg_max.append(np.max(np.load('DDPG_Cost0.5_' + str(i) + '.npy')))

    static_graph.append(np.mean(np.load('Head_cost0.5_'+str(i)+'.npy')))
    static_min.append(np.min(np.load('Head_cost0.5_'+str(i)+'.npy')))
    static_max.append(np.max(np.load('Head_cost0.5_' + str(i) + '.npy')))

    md_graph.append(np.mean(np.load('MD_cost0.5_'+str(i)+'.npy')))
    md_min.append(np.min(np.load('MD_cost0.5_'+str(i)+'.npy')))
    md_max.append(np.max(np.load('MD_cost0.5_'+str(i)+'.npy')))

    edge_graph.append(np.mean(np.load('Edge_cost0.5_'+str(i)+'.npy')))
    edge_min.append(np.min(np.load('Edge_cost0.5_' + str(i) + '.npy')))
    edge_max.append(np.max(np.load('Edge_cost0.5_' + str(i) + '.npy')))

    rand_graph.append(np.mean(np.load('RAND_cost0.5_'+str(i)+'.npy')))
    rand_min.append(np.min(np.load('RAND_cost0.5_' + str(i) + '.npy')))
    rand_max.append(np.max(np.load('RAND_cost0.5_' + str(i) + '.npy')))



print(ddpg_graph-np.array(ddpg_max))
print(ddpg_graph-np.array(ddpg_min))
...
markersize=8
# plt.plot(axis_x, -np.array(ddpg_graph), label = 'DS2CF', zorder=2,marker='o',color='black',markerfacecolor='white',markersize=markersize)
...
#,yerr=[-np.array(_graph)+np.array(_max),np.array(_graph)-np.array(_min)],
...
plt.savefig('../r.eps',dpi=200,transparent=True,bbox_inches='tight')
plt.show()
# target_acc=70
