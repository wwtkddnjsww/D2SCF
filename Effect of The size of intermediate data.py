...
for i in range(len(experiment_list)):
    ...
    state = SC_MTL_State()
    state.set_parameter(bandwidth, layers_size, experiment_list[i])
    ...
    np.save('Intermediate/result/DDPG_Cost'+str(cost_weight)+"_" + str(i) + '.npy', returns)
    np.save('Intermediate/result/Edge_Cost'+str(cost_weight)+"_" + str(i) + '.npy', edge_returns)
    np.save('Intermediate/result/MD_Cost'+str(cost_weight)+"_" + str(i) + '.npy', md_returns)
    np.save('Intermediate/result/Head_Cost'+str(cost_weight)+"_" + str(i) + '.npy', head_returns)
    np.save('Intermediate/result/RAND_Cost'+str(cost_weight)+"_" + str(i) + '.npy', random_returns)

    np.save('Intermediate/result/DDPG_EC'+str(cost_weight)+"_" + str(i) + '.npy', ddpg_avg_ec)
    np.save('Intermediate/result/DDPG_TC'+str(cost_weight)+"_" + str(i) + '.npy', ddpg_avg_tc)
    np.save('Intermediate/result/EDGE_EC'+str(cost_weight)+"_" + str(i) + '.npy', edge_avg_ec)
    np.save('Intermediate/result/EDGE_TC'+str(cost_weight)+"_" + str(i) + '.npy', edge_avg_tc)
    np.save('Intermediate/result/Head_EC' +str(cost_weight)+"_"+ str(i) + '.npy', head_avg_ec)
    np.save('Intermediate/result/Head_TC'+str(cost_weight)+"_" + str(i) + '.npy', head_avg_tc)
    np.save('Intermediate/result/MD_EC'+str(cost_weight)+"_" + str(i) + '.npy', md_avg_ec)
    np.save('Intermediate/result/MD_TC'+str(cost_weight)+"_" + str(i) + '.npy', md_avg_tc)
    np.save('Intermediate/result/RAND_EC'+str(cost_weight)+"_" + str(i) + '.npy', rand_avg_ec)
    np.save('Intermediate/result/RAND_TC'+str(cost_weight)+"_" + str(i) + '.npy', rand_avg_tc)
