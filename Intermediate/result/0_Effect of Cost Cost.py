...
for i in range(len(axis_x)):
    ddpg = np.load('DDPG_Cost0.1_' + str(i) + '.npy')
    ddpg_graph.append(np.mean(ddpg))
    ddpg_min.append(np.min(np.load('DDPG_Cost0.1_' + str(i) + '.npy')))
    ddpg_max.append(np.max(np.load('DDPG_Cost0.1_' + str(i) + '.npy')))

    static_graph.append(np.mean(np.load('Head_cost0.1_'+str(i)+'.npy')))
    static_min.append(np.min(np.load('Head_cost0.1_'+str(i)+'.npy')))
    static_max.append(np.max(np.load('Head_cost0.1_' + str(i) + '.npy')))

    md_graph.append(np.mean(np.load('MD_cost0.1_'+str(i)+'.npy')))
    md_min.append(np.min(np.load('MD_cost0.1_'+str(i)+'.npy')))
    md_max.append(np.max(np.load('MD_cost0.1_'+str(i)+'.npy')))

    edge_graph.append(np.mean(np.load('Edge_cost0.1_'+str(i)+'.npy')))
    edge_min.append(np.min(np.load('Edge_cost0.1_' + str(i) + '.npy')))
    edge_max.append(np.max(np.load('Edge_cost0.1_' + str(i) + '.npy')))

    rand_graph.append(np.mean(np.load('RAND_cost0.1_'+str(i)+'.npy')))
    rand_min.append(np.min(np.load('RAND_cost0.1_' + str(i) + '.npy')))
    rand_max.append(np.max(np.load('RAND_cost0.1_' + str(i) + '.npy')))
...
plt.legend(edgecolor='black',fontsize=14,fancybox=False, bbox_to_anchor=(0.1,0.5))
